...
import RecentPrompts from "@/app/(protected)/(pages)/(dashboardPages)/create-page/_components/GenerativeAI/RecentPrompt";
import {
  containerVariants,
  CreatePageCard,
  itemVariants,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-secondary">Choose your perferred method to begin</p>
      </motion.div>
      <motion.div
        variants={containerVariants}
